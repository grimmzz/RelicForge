...
namespace RelicForge.Content.Items
{
    public class FroYo : ModItem
    {
        ...
        {
            Item.width = 60; // The width of the item's hitbox.
            Item.height = 52; // The height of the item's hitbox.
            ...
            Item.shoot = ModContent.ProjectileType<FroYoProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.IceBlock, 25); // Required material
            recipe.AddIngredient(ItemID.SnowFallBlock, 50); // Required material
