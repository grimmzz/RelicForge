...
namespace RelicForge.Content.Items
{
    public class TumbleWeed : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TumbleWeedProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.SandBlock, 25); // Required material
            recipe.AddIngredient(ItemID.Amber, 15); // Required material
